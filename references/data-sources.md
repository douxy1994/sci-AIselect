# sci-aiselect Data Sources

sci-aiselect uses public journal metadata by default.
...
If OpenAlex fails or has no matching source, sci-aiselect reports `OpenAlex未获取` instead of filling in unknown values.
